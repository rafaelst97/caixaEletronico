...
function toWithdraw (value){
    ...
    let bankNotes = [500, 200, 100, 50, 20, 10, 5, 1];
    let bankNotesCounted = [0, 0, 0, 0, 0, 0, 0, 0];
    ...
    for (let i = 0; i < bankNotesCounted.length; i++){
        ...
        valueTh.textContent = bankNotes[i]; // Passagem do valor de cada cédula para o topo da tabela
